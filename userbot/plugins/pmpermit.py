...
#    maked by RetroBot22 🔥🔥🔥🔥 helper shivam ⚡⚡⚡
    ...
    if event.is_private:
        ...
        if not lightning_sql.is_approved(chats.id):
            ...
            await borg.send_message(
                ...
                chats, "**Heya @RetroBot22 YOU ARE MY CREATOR I APPROVED YOU SIR ❤️🥰🔥⚜️**"
    ...
    if event.is_private:
        ...
        if not lightning_sql.is_approved(chats.id):
            ...
            await borg.send_message(
                ...
                chats, f"**Good To See You @RetroBot22 How Can I Disapprove You Come In Sir**ðð"
